...
declare module Phaser.Plugin {
    ...
    module Isometric {
        ...
        // Added by dekajoo@gmail.com
        class Game extends Phaser.Game {
            physics: Phaser.Plugin.Isometric.Physics;
            add: Phaser.Plugin.Isometric.GameObjectFactory;
        ...
        class GameObjectFactory extends Phaser.GameObjectFactory {
            isoSprite(x: number, y: number, z: number, tileSet: string, tile: number | string, isoGroup: Phaser.Group): Phaser.Plugin.Isometric.IsoSprite;
        }
